...
parser.add_argument('--folder_name_extension', nargs='?', default="_labelflip_40", type=str, help='Set folder name extension')
...
print("rewardsystemslabelflip", args.rewardsystemslabelflip)
