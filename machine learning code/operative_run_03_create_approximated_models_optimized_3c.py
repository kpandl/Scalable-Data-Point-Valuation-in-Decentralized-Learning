...
parser.add_argument('--name_of_test_folder', nargs='?', default="default0_reduced_maxtranslation_0.1_knn_scalability_2_clients", type=str, help='Specify the name of the test folder')
parser.add_argument('--dscmode', nargs='?', default=48, type=int, help='Specify the dataset collection mode')
...
function_to_run = sc.create_artificial_models
