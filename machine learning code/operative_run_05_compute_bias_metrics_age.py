...
parser.add_argument('--name_of_test_folder', nargs='?', default="default0_reduced_maxtranslation_0.1final_age_quantile_100_0", type=str, help='Specify the name of the test folder')
