...
parser.add_argument('--name_of_test_folder', nargs='?', default="default0_reduced_maxtranslation_0.1goodgendersetting_15k_noGradientClip", type=str, help='Specify the name of the test folder')
