...
parser.add_argument('--dscmode', nargs='?', default=21, type=int, help='Specify the dataset collection mode')
...
parser.add_argument('--sex_based_split', dest='sex_based_split', action='store_true')
parser.set_defaults(sex_based_split=False)
...
if __name__ == "__main__": 
    globals.initialize()
    sc.compute_shapley_values(based_on_age=True, originally_sex_based=args.sex_based_split)