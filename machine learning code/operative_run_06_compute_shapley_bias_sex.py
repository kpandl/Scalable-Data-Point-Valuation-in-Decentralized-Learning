...
parser.add_argument('--seed', nargs='?', default=1, type=int, help='Specify the random seed')
...
parser.add_argument('--name_of_test_folder', nargs='?', default="default1_reduced_maxtranslation_0.1goodgendersetting_15k_noGradientClip_age1", type=str, help='Specify the name of the test folder')
parser.add_argument('--dscmode', nargs='?', default=13, type=int, help='Specify the dataset collection mode')
