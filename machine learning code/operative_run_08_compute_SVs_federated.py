...
parser.add_argument('--name_of_test_folder', nargs='?', default="default0_reduced_maxtranslation_0.1sex_as_is_knn_lableflip", type=str, help='Specify the name of the test folder')
parser.add_argument('--dscmode', nargs='?', default=41, type=int, help='Specify the dataset collection mode')
parser.add_argument('--specific_label_id', nargs='?', default=-1, type=int, help='Specify the SV specific label id')
...
parser.add_argument('--limit_collected_dataset', nargs='?', default=-1, type=int, help='Specify the dataset collection size')
...
if __name__ == "__main__": 
    ...
    sc.compute_knn_shapley_values_federated(specific_label_id=args.specific_label_id, limit_collected_dataset=args.limit_collected_dataset)