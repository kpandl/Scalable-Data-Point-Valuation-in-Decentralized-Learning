...
parser.add_argument('--start_environment', nargs='?', default=6, type=int, help='Specify the start federated learning environment')
...
if __name__ == "__main__": 
    ...
    sc.compute_knn_shapley_values_federated(specific_label_id=args.specific_label_id, noise=True)