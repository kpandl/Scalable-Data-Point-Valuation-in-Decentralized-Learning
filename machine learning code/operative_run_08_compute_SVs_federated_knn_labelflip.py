...
parser.add_argument('--name_of_test_folder', nargs='?', default="default0_reduced_maxtranslation_0.1_labelflip_40", type=str, help='Specify the name of the test folder')
...
if __name__ == "__main__": 
    ...
    sc.compute_knn_shapley_values_federated(specific_label_id=args.specific_label_id, only_even_clients=True)