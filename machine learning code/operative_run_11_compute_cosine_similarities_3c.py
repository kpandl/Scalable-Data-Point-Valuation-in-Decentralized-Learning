...
if(os.path.exists(path_results_cosinesimilarity)):
    print("deleting file")
    os.remove(path_results_cosinesimilarity)
...
compute_cosine_similarity_for_file("Shapley_federated_performance.csv", "FedKNN", "performance")
