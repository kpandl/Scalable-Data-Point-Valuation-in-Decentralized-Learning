...
parser.add_argument('--name_of_test_folder', nargs='?', default="default0_reduced_maxtranslation_0.1final_50_50", type=str, help='Specify the name of the test folder')
parser.add_argument('--dscmode', nargs='?', default=15, type=int, help='Specify the dataset collection mode')
